...
if __name__ == "__main__":
    ...
    ap.add_argument("--tasks", default="grasp,pour,insert"); ap.add_argument("--verify", action="store_true")
    ...
    total = sum(cache_cell(t, m, raw, feat, a.source, model, proc, dev, a.batch) for t in a.tasks.split(",") for m in MATERIALS)
    cache_text(model, proc, feat, dev)
